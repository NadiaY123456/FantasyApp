...
//    let side = initPoseName.footOnGround
//    
//    return side
//}
//
...
//
//    if initSide == .right {
//        targetPoses = [.wL_neutral_to_wlean_fR, .wL_neutral_to_wlean_fL, .wL_wlean_to_lean_fR, .wL_wlean_to_lean_fL]
//    } else if initSide == .left {
//        targetPoses = [.wR_neutral_to_wlean_fL, .wR_neutral_to_wlean_fR, .wR_wlean_to_lean_fL, .wR_wlean_to_lean_fR]
//    } else {
//        targetPoses = []
//    }
//    
